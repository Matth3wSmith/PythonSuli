...
def kajaCheck():
    ...
    for egyKaja in kajaLista:
        ...
        #Ha eléri a kaját
        if x**2+y**2 <= ((labdaSize+kajaSize)*0.6)**2:
            canvas.delete(kajaLista[0])
            kajaLista.pop(0)
#ablak létrehozása
win=Tk()
...
pontAblak=Frame(borderwidth="10",relief="ridge", width=100, height=100)
pontIras=Label(master=pontAblak,text="Elért pontszám: "+str(pont))
pontIras.pack()
pontAblak.pack(side="top")
